...
class Expense extends DataClass implements Insertable<Expense> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, title, category, amount, incurredOn, note);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Expense &&
...
class StockMovement extends DataClass implements Insertable<StockMovement> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, productId, type, qty, note, createdAt, userId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class CustomerPayment extends DataClass implements Insertable<CustomerPayment> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, customerId, amount, note, createdAt, userId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Supplier extends DataClass implements Insertable<Supplier> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, phone, email, address, balance, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Supplier &&
...
class PurchaseOrder extends DataClass implements Insertable<PurchaseOrder> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, supplierId, status, total, note, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class PurchaseOrderItem extends DataClass
  ...
  @override
  int get hashCode => Object.hash(id, orderId, productId, qty, costPrice);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class LoyaltyTransaction extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, customerId, points, type, saleId, note, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class CashMovement extends DataClass implements Insertable<CashMovement> {
  ...
  @override
  int get hashCode => Object.hash(id, shiftId, type, amount, reason, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $InvoicesTable extends Invoices with TableInfo<$InvoicesTable, Invoice> {
  ...
  static const VerificationMeta _linkedSaleIdMeta = const VerificationMeta(
    'linkedSaleId',
  );
  @override
  late final GeneratedColumn<int> linkedSaleId = GeneratedColumn<int>(
    'linked_sale_id',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _billToNameMeta = const VerificationMeta(
    'billToName',
  );
  @override
  late final GeneratedColumn<String> billToName = GeneratedColumn<String>(
    'bill_to_name',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _billToAddressMeta = const VerificationMeta(
    'billToAddress',
  );
  @override
  late final GeneratedColumn<String> billToAddress = GeneratedColumn<String>(
    'bill_to_address',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _billToPhoneMeta = const VerificationMeta(
    'billToPhone',
  );
  @override
  late final GeneratedColumn<String> billToPhone = GeneratedColumn<String>(
    'bill_to_phone',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _invoiceLanguageMeta = const VerificationMeta(
    'invoiceLanguage',
  );
  @override
  late final GeneratedColumn<String> invoiceLanguage = GeneratedColumn<String>(
    'invoice_language',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _exchangeRateToPkrMeta = const VerificationMeta(
    'exchangeRateToPkr',
  );
  @override
  late final GeneratedColumn<double> exchangeRateToPkr =
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('linked_sale_id')) {
      context.handle(
        _linkedSaleIdMeta,
        linkedSaleId.isAcceptableOrUnknown(
          data['linked_sale_id']!,
          _linkedSaleIdMeta,
        ),
      );
    ...
    if (data.containsKey('bill_to_name')) {
      context.handle(
        _billToNameMeta,
        billToName.isAcceptableOrUnknown(
          data['bill_to_name']!,
          _billToNameMeta,
        ),
      );
    }
    if (data.containsKey('bill_to_address')) {
      context.handle(
        _billToAddressMeta,
        billToAddress.isAcceptableOrUnknown(
          data['bill_to_address']!,
          _billToAddressMeta,
        ),
      );
    }
    if (data.containsKey('bill_to_phone')) {
      context.handle(
        _billToPhoneMeta,
        billToPhone.isAcceptableOrUnknown(
          data['bill_to_phone']!,
          _billToPhoneMeta,
        ),
      );
    ...
    if (data.containsKey('invoice_language')) {
      context.handle(
        _invoiceLanguageMeta,
        invoiceLanguage.isAcceptableOrUnknown(
    ...
    if (data.containsKey('exchange_rate_to_pkr')) {
      context.handle(
        _exchangeRateToPkrMeta,
        exchangeRateToPkr.isAcceptableOrUnknown(
          data['exchange_rate_to_pkr']!,
          _exchangeRateToPkrMeta,
        ),
      );
    }
  ...
  Invoice map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Invoice(
      ...
      linkedSaleId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}linked_sale_id'],
      ),
      docType: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}doc_type'],
      )!,
      billToName: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}bill_to_name'],
      ),
      billToAddress: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}bill_to_address'],
      ),
      billToPhone: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}bill_to_phone'],
      ),
      status: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}status'],
      ...
      invoiceLanguage: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}invoice_language'],
      )!,
      currencyCode: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}currency_code'],
      )!,
      exchangeRateToPkr: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}exchange_rate_to_pkr'],
      )!,
...
class Invoice extends DataClass implements Insertable<Invoice> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || linkedSaleId != null) {
      map['linked_sale_id'] = Variable<int>(linkedSaleId);
    }
    map['doc_type'] = Variable<String>(docType);
    if (!nullToAbsent || billToName != null) {
      map['bill_to_name'] = Variable<String>(billToName);
    }
    if (!nullToAbsent || billToAddress != null) {
      map['bill_to_address'] = Variable<String>(billToAddress);
    }
    if (!nullToAbsent || billToPhone != null) {
      map['bill_to_phone'] = Variable<String>(billToPhone);
    }
    map['status'] = Variable<String>(status);
    map['template'] = Variable<String>(template);
    map['invoice_language'] = Variable<String>(invoiceLanguage);
    map['currency_code'] = Variable<String>(currencyCode);
    map['exchange_rate_to_pkr'] = Variable<double>(exchangeRateToPkr);
  ...
  InvoicesCompanion toCompanion(bool nullToAbsent) {
    return InvoicesCompanion(
      ...
      customerId: customerId == null && nullToAbsent
          ? const Value.absent()
          : Value(customerId),
      linkedSaleId: linkedSaleId == null && nullToAbsent
          ? const Value.absent()
          : Value(linkedSaleId),
      docType: Value(docType),
      billToName: billToName == null && nullToAbsent
          ? const Value.absent()
          : Value(billToName),
      billToAddress: billToAddress == null && nullToAbsent
          ? const Value.absent()
          : Value(billToAddress),
      billToPhone: billToPhone == null && nullToAbsent
          ? const Value.absent()
          : Value(billToPhone),
      status: Value(status),
      ...
      exchangeRateToPkr: Value(exchangeRateToPkr),
  ...
  factory Invoice.fromJson(
    ...
    return Invoice(
      ...
      customerId: serializer.fromJson<int?>(json['customerId']),
      linkedSaleId: serializer.fromJson<int?>(json['linkedSaleId']),
      docType: serializer.fromJson<String>(json['docType']),
      billToName: serializer.fromJson<String?>(json['billToName']),
      billToAddress: serializer.fromJson<String?>(json['billToAddress']),
      billToPhone: serializer.fromJson<String?>(json['billToPhone']),
      status: serializer.fromJson<String>(json['status']),
      template: serializer.fromJson<String>(json['template']),
      invoiceLanguage: serializer.fromJson<String>(json['invoiceLanguage']),
      currencyCode: serializer.fromJson<String>(json['currencyCode']),
      exchangeRateToPkr: serializer.fromJson<double>(json['exchangeRateToPkr']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'customerId': serializer.toJson<int?>(customerId),
      'linkedSaleId': serializer.toJson<int?>(linkedSaleId),
      'docType': serializer.toJson<String>(docType),
      'billToName': serializer.toJson<String?>(billToName),
      'billToAddress': serializer.toJson<String?>(billToAddress),
      'billToPhone': serializer.toJson<String?>(billToPhone),
      'status': serializer.toJson<String>(status),
      'template': serializer.toJson<String>(template),
      'invoiceLanguage': serializer.toJson<String>(invoiceLanguage),
      'currencyCode': serializer.toJson<String>(currencyCode),
      'exchangeRateToPkr': serializer.toJson<double>(exchangeRateToPkr),
  ...
  Invoice copyWith({
    ...
    Value<int?> customerId = const Value.absent(),
    Value<int?> linkedSaleId = const Value.absent(),
    String? docType,
    Value<String?> billToName = const Value.absent(),
    Value<String?> billToAddress = const Value.absent(),
    Value<String?> billToPhone = const Value.absent(),
    String? status,
    String? template,
    String? invoiceLanguage,
    String? currencyCode,
    double? exchangeRateToPkr,
    ...
    customerId: customerId.present ? customerId.value : this.customerId,
    linkedSaleId: linkedSaleId.present ? linkedSaleId.value : this.linkedSaleId,
    docType: docType ?? this.docType,
    billToName: billToName.present ? billToName.value : this.billToName,
    billToAddress: billToAddress.present
        ? billToAddress.value
        : this.billToAddress,
    billToPhone: billToPhone.present ? billToPhone.value : this.billToPhone,
    status: status ?? this.status,
    template: template ?? this.template,
    invoiceLanguage: invoiceLanguage ?? this.invoiceLanguage,
    currencyCode: currencyCode ?? this.currencyCode,
    exchangeRateToPkr: exchangeRateToPkr ?? this.exchangeRateToPkr,
  ...
  Invoice copyWithCompanion(InvoicesCompanion data) {
    return Invoice(
      ...
      customerId: data.customerId.present
          ? data.customerId.value
          : this.customerId,
      linkedSaleId: data.linkedSaleId.present
          ? data.linkedSaleId.value
          : this.linkedSaleId,
      docType: data.docType.present ? data.docType.value : this.docType,
      billToName: data.billToName.present
          ? data.billToName.value
          : this.billToName,
      billToAddress: data.billToAddress.present
          ? data.billToAddress.value
          : this.billToAddress,
      billToPhone: data.billToPhone.present
          ? data.billToPhone.value
          : this.billToPhone,
      status: data.status.present ? data.status.value : this.status,
      template: data.template.present ? data.template.value : this.template,
      invoiceLanguage: data.invoiceLanguage.present
          ? data.invoiceLanguage.value
          : this.invoiceLanguage,
      currencyCode: data.currencyCode.present
          ? data.currencyCode.value
          : this.currencyCode,
      exchangeRateToPkr: data.exchangeRateToPkr.present
          ? data.exchangeRateToPkr.value
          : this.exchangeRateToPkr,
  ...
  String toString() {
    return (StringBuffer('Invoice(')
          ...
          ..write('customerId: $customerId, ')
          ..write('linkedSaleId: $linkedSaleId, ')
          ..write('docType: $docType, ')
          ..write('billToName: $billToName, ')
          ..write('billToAddress: $billToAddress, ')
          ..write('billToPhone: $billToPhone, ')
          ..write('status: $status, ')
          ..write('template: $template, ')
          ..write('invoiceLanguage: $invoiceLanguage, ')
          ..write('currencyCode: $currencyCode, ')
          ..write('exchangeRateToPkr: $exchangeRateToPkr, ')
          ..write('sentAt: $sentAt, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Invoice &&
          ...
          other.customerId == this.customerId &&
          other.linkedSaleId == this.linkedSaleId &&
          other.docType == this.docType &&
          other.billToName == this.billToName &&
          other.billToAddress == this.billToAddress &&
          other.billToPhone == this.billToPhone &&
          other.status == this.status &&
          other.template == this.template &&
          other.invoiceLanguage == this.invoiceLanguage &&
          other.currencyCode == this.currencyCode &&
          other.exchangeRateToPkr == this.exchangeRateToPkr &&
...
class InvoicesCompanion extends UpdateCompanion<Invoice> {
  ...
  final Value<int?> customerId;
  final Value<int?> linkedSaleId;
  final Value<String> docType;
  final Value<String?> billToName;
  final Value<String?> billToAddress;
  final Value<String?> billToPhone;
  final Value<String> status;
  final Value<String> template;
  final Value<String> invoiceLanguage;
  final Value<String> currencyCode;
  final Value<double> exchangeRateToPkr;
  ...
  const InvoicesCompanion({
    ...
    this.customerId = const Value.absent(),
    this.linkedSaleId = const Value.absent(),
    this.docType = const Value.absent(),
    this.billToName = const Value.absent(),
    this.billToAddress = const Value.absent(),
    this.billToPhone = const Value.absent(),
    this.status = const Value.absent(),
    this.template = const Value.absent(),
    this.invoiceLanguage = const Value.absent(),
    this.currencyCode = const Value.absent(),
    this.exchangeRateToPkr = const Value.absent(),
  ...
  static Insertable<Invoice> custom({
    ...
    Expression<int>? customerId,
    Expression<int>? linkedSaleId,
    Expression<String>? docType,
    Expression<String>? billToName,
    Expression<String>? billToAddress,
    Expression<String>? billToPhone,
    Expression<String>? status,
    Expression<String>? template,
    Expression<String>? invoiceLanguage,
    Expression<String>? currencyCode,
    Expression<double>? exchangeRateToPkr,
    ...
    return RawValuesInsertable({
      ...
      if (customerId != null) 'customer_id': customerId,
      if (linkedSaleId != null) 'linked_sale_id': linkedSaleId,
      if (docType != null) 'doc_type': docType,
      if (billToName != null) 'bill_to_name': billToName,
      if (billToAddress != null) 'bill_to_address': billToAddress,
      if (billToPhone != null) 'bill_to_phone': billToPhone,
      if (status != null) 'status': status,
      if (template != null) 'template': template,
      if (invoiceLanguage != null) 'invoice_language': invoiceLanguage,
      if (currencyCode != null) 'currency_code': currencyCode,
      if (exchangeRateToPkr != null) 'exchange_rate_to_pkr': exchangeRateToPkr,
  ...
  InvoicesCompanion copyWith({
    ...
    Value<int?>? customerId,
    Value<int?>? linkedSaleId,
    Value<String>? docType,
    Value<String?>? billToName,
    Value<String?>? billToAddress,
    Value<String?>? billToPhone,
    Value<String>? status,
    Value<String>? template,
    Value<String>? invoiceLanguage,
    Value<String>? currencyCode,
    Value<double>? exchangeRateToPkr,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (linkedSaleId.present) {
      map['linked_sale_id'] = Variable<int>(linkedSaleId.value);
    }
    if (docType.present) {
      map['doc_type'] = Variable<String>(docType.value);
    }
    if (billToName.present) {
      map['bill_to_name'] = Variable<String>(billToName.value);
    }
    if (billToAddress.present) {
      map['bill_to_address'] = Variable<String>(billToAddress.value);
    }
    if (billToPhone.present) {
      map['bill_to_phone'] = Variable<String>(billToPhone.value);
    }
    if (status.present) {
      map['status'] = Variable<String>(status.value);
    }
    ...
    if (invoiceLanguage.present) {
      map['invoice_language'] = Variable<String>(invoiceLanguage.value);
    }
    if (currencyCode.present) {
      map['currency_code'] = Variable<String>(currencyCode.value);
    }
    if (exchangeRateToPkr.present) {
      map['exchange_rate_to_pkr'] = Variable<double>(exchangeRateToPkr.value);
    }
    if (sentAt.present) {
...
class InvoiceItem extends DataClass implements Insertable<InvoiceItem> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, invoiceId, description, qty, unitPrice, lineTotal);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class InvoicePayment extends DataClass implements Insertable<InvoicePayment> {
  ...
  @override
  int get hashCode => Object.hash(id, invoiceId, amount, method, paidAt, note);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $RecurringInvoicesTable extends RecurringInvoices
  ...
  static const VerificationMeta _templateInvoiceIdMeta = const VerificationMeta(
    'templateInvoiceId',
  );
  @override
  late final GeneratedColumn<int> templateInvoiceId = GeneratedColumn<int>(
    'template_invoice_id',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('template_invoice_id')) {
      context.handle(
        _templateInvoiceIdMeta,
        templateInvoiceId.isAcceptableOrUnknown(
          data['template_invoice_id']!,
          _templateInvoiceIdMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_templateInvoiceIdMeta);
    }
  ...
  RecurringInvoice map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return RecurringInvoice(
      ...
      templateInvoiceId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}template_invoice_id'],
      )!,
...
class RecurringInvoice extends DataClass
  ...
  const RecurringInvoice({
    required this.id,
    required this.templateInvoiceId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['template_invoice_id'] = Variable<int>(templateInvoiceId);
  ...
  RecurringInvoicesCompanion toCompanion(bool nullToAbsent) {
    return RecurringInvoicesCompanion(
      id: Value(id),
      templateInvoiceId: Value(templateInvoiceId),
  ...
  factory RecurringInvoice.fromJson(
    ...
    return RecurringInvoice(
      id: serializer.fromJson<int>(json['id']),
      templateInvoiceId: serializer.fromJson<int>(json['templateInvoiceId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'templateInvoiceId': serializer.toJson<int>(templateInvoiceId),
  ...
  RecurringInvoice copyWith({
    ...
    id: id ?? this.id,
    templateInvoiceId: templateInvoiceId ?? this.templateInvoiceId,
  ...
  RecurringInvoice copyWithCompanion(RecurringInvoicesCompanion data) {
    return RecurringInvoice(
      id: data.id.present ? data.id.value : this.id,
      templateInvoiceId: data.templateInvoiceId.present
          ? data.templateInvoiceId.value
  ...
  String toString() {
    return (StringBuffer('RecurringInvoice(')
          ..write('id: $id, ')
          ..write('templateInvoiceId: $templateInvoiceId, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is RecurringInvoice &&
          other.id == this.id &&
          other.templateInvoiceId == this.templateInvoiceId &&
...
class RecurringInvoicesCompanion extends UpdateCompanion<RecurringInvoice> {
  final Value<int> id;
  final Value<int> templateInvoiceId;
  ...
  const RecurringInvoicesCompanion({
    this.id = const Value.absent(),
    this.templateInvoiceId = const Value.absent(),
  ...
  static Insertable<RecurringInvoice> custom({
    Expression<int>? id,
    Expression<int>? templateInvoiceId,
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (templateInvoiceId != null) 'template_invoice_id': templateInvoiceId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (templateInvoiceId.present) {
      map['template_invoice_id'] = Variable<int>(templateInvoiceId.value);
    }
...
final class $$SalesTableReferences
  ...
  static MultiTypedResultKey<$InvoicesTable, List<Invoice>> _invoicesRefsTable(
    ...
    db.invoices,
    aliasName: $_aliasNameGenerator(db.sales.id, db.invoices.linkedSaleId),
  );
  ...
  $$InvoicesTableProcessedTableManager get invoicesRefs {
    final manager = $$InvoicesTableTableManager(
      $_db,
      $_db.invoices,
    ).filter((f) => f.linkedSaleId.id.sqlEquals($_itemColumn<int>('id')!));
...
class $$SalesTableFilterComposer extends Composer<_$AppDatabase, $SalesTable> {
  ...
  Expression<bool> invoicesRefs(
    ...
    final $$InvoicesTableFilterComposer composer = $composerBuilder(
      ...
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.invoices,
      getReferencedColumn: (t) => t.linkedSaleId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
...
final class $$LoyaltyTransactionsTableReferences
  ...
  static $SalesTable _saleIdTable(_$AppDatabase db) => db.sales.createAlias(
    $_aliasNameGenerator(db.loyaltyTransactions.saleId, db.sales.id),
  );
...
class $$ShiftsTableTableManager
    extends
        RootTableManager<
          ...
          Shift,
          PrefetchHooks Function({bool userId, bool cashMovementsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({userId = false, cashMovementsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
...
final class $$InvoicesTableReferences
  ...
  static $SalesTable _linkedSaleIdTable(_$AppDatabase db) => db.sales
      .createAlias($_aliasNameGenerator(db.invoices.linkedSaleId, db.sales.id));

  $$SalesTableProcessedTableManager? get linkedSaleId {
    final $_column = $_itemColumn<int>('linked_sale_id');
    if ($_column == null) return null;
    final manager = $$SalesTableTableManager(
      $_db,
      $_db.sales,
    ).filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_linkedSaleIdTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
    );
  ...
  _recurringInvoicesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.invoices.id,
          db.recurringInvoices.templateInvoiceId,
        ),
      );
  ...
  $$RecurringInvoicesTableProcessedTableManager get recurringInvoicesRefs {
    ...
    ).filter((f) => f.templateInvoiceId.id.sqlEquals($_itemColumn<int>('id')!));
...
class $$InvoicesTableFilterComposer
  ...
  ColumnFilters<String> get billToName => $composableBuilder(
    column: $table.billToName,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get billToAddress => $composableBuilder(
    column: $table.billToAddress,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get billToPhone => $composableBuilder(
    column: $table.billToPhone,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<String> get invoiceLanguage => $composableBuilder(
    column: $table.invoiceLanguage,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<double> get exchangeRateToPkr => $composableBuilder(
    column: $table.exchangeRateToPkr,
    builder: (column) => ColumnFilters(column),
  );
  ...
  $$SalesTableFilterComposer get linkedSaleId {
    final $$SalesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.linkedSaleId,
      referencedTable: $db.sales,
      getReferencedColumn: (t) => t.id,
      builder:
          (
  ...
  Expression<bool> recurringInvoicesRefs(
    ...
    final $$RecurringInvoicesTableFilterComposer composer = $composerBuilder(
      ...
      getReferencedColumn: (t) => t.templateInvoiceId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
...
class $$InvoicesTableOrderingComposer
  ...
  ColumnOrderings<String> get billToName => $composableBuilder(
    column: $table.billToName,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get billToAddress => $composableBuilder(
    column: $table.billToAddress,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get billToPhone => $composableBuilder(
    column: $table.billToPhone,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<String> get invoiceLanguage => $composableBuilder(
    column: $table.invoiceLanguage,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<double> get exchangeRateToPkr => $composableBuilder(
    column: $table.exchangeRateToPkr,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  $$SalesTableOrderingComposer get linkedSaleId {
    final $$SalesTableOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.linkedSaleId,
      referencedTable: $db.sales,
...
class $$InvoicesTableAnnotationComposer
  ...
  GeneratedColumn<String> get billToName => $composableBuilder(
    column: $table.billToName,
    builder: (column) => column,
  );

  GeneratedColumn<String> get billToAddress => $composableBuilder(
    column: $table.billToAddress,
    builder: (column) => column,
  );

  GeneratedColumn<String> get billToPhone => $composableBuilder(
    column: $table.billToPhone,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<String> get invoiceLanguage => $composableBuilder(
    column: $table.invoiceLanguage,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<double> get exchangeRateToPkr => $composableBuilder(
    column: $table.exchangeRateToPkr,
    builder: (column) => column,
  );
  ...
  $$SalesTableAnnotationComposer get linkedSaleId {
    final $$SalesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.linkedSaleId,
      referencedTable: $db.sales,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> invoiceLanguage = const Value.absent(),
                Value<String> currencyCode = const Value.absent(),
                Value<double> exchangeRateToPkr = const Value.absent(),
                Value<DateTime?> sentAt = const Value.absent(),
                ...
                exchangeRateToPkr: exchangeRateToPkr,
                sentAt: sentAt,
                issueDate: issueDate,
                dueDate: dueDate,
                      ...
                      >(state) {
                        ...
                        if (linkedSaleId) {
                          state =
                              state.withJoin(
                                    currentTable: table,
                                    currentColumn: table.linkedSaleId,
                                    referencedTable: $$InvoicesTableReferences
                                        ._linkedSaleIdTable(db),
                                    referencedColumn: $$InvoicesTableReferences
                                        ._linkedSaleIdTable(db)
                                        .id,
                                  )
...
final class $$RecurringInvoicesTableReferences
  ...
  static $InvoicesTable _templateInvoiceIdTable(_$AppDatabase db) =>
      db.invoices.createAlias(
        $_aliasNameGenerator(
          db.recurringInvoices.templateInvoiceId,
          db.invoices.id,
  ...
  $$InvoicesTableProcessedTableManager get templateInvoiceId {
    final $_column = $_itemColumn<int>('template_invoice_id')!;

    final manager = $$InvoicesTableTableManager(
      $_db,
      $_db.invoices,
    ).filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_templateInvoiceIdTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
    );
...
class $$RecurringInvoicesTableFilterComposer
  ...
  $$InvoicesTableFilterComposer get templateInvoiceId {
    final $$InvoicesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.templateInvoiceId,
      referencedTable: $db.invoices,
      getReferencedColumn: (t) => t.id,
      builder:
          (
...
class $$RecurringInvoicesTableOrderingComposer
  ...
  $$InvoicesTableOrderingComposer get templateInvoiceId {
    final $$InvoicesTableOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.templateInvoiceId,
      referencedTable: $db.invoices,
...
class $$RecurringInvoicesTableAnnotationComposer
  ...
  $$InvoicesTableAnnotationComposer get templateInvoiceId {
    final $$InvoicesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.templateInvoiceId,
      referencedTable: $db.invoices,
...
class $$RecurringInvoicesTableTableManager
    extends
        RootTableManager<
          ...
          RecurringInvoice,
          PrefetchHooks Function({bool templateInvoiceId})
        > {
    ...
    $RecurringInvoicesTable table,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<int> templateInvoiceId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({templateInvoiceId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
                  ...
                  >(state) {
                    if (templateInvoiceId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.templateInvoiceId,
                                referencedTable:
                                    $$RecurringInvoicesTableReferences
                                        ._templateInvoiceIdTable(db),
                                referencedColumn:
                                    $$RecurringInvoicesTableReferences
                                        ._templateInvoiceIdTable(db)
                                        .id,
